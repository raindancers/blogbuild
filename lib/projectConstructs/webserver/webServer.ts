 ...
 */
export class WebServer extends constructs.Construct {

	webserver: ec2.Instance

	constructor(scope: constructs.Construct, id: string, props: WebServerProps) {
		super(scope, id) 
		...
		this.webserver.addUserData(fs.readFileSync('.lib/userdata/webserver-user-data.sh', 'utf8'));
