...
export class EnterpriseZone extends constructs.Construct {
  ...
  constructor(scope: constructs.Construct, id: string, props: EnterpriseZoneProps) {
    ...
    props.remoteVpc.forEach((remoteVpc, index) => {
      ...
      const createAssn = new cr.AwsCustomResource(this, `createR53Assn${index}`, {
        onCreate: {
          service: 'Route53',
      ...
      const associateCentralVpcwithZone = new aws_lambda.Function(this, `${index}associateLambda`, {
